 ...
 *                                     → unsigned int bitBuf
 *
 *              Reason for two coexisting versions in Arduino libraries:
 *                - ESP32-audioI2S-nopsram (v99.0.0 = v2.0.6 patched)
 *                  → ESP32 dev, no PSRAM
 *                - ESP32-audioI2S-psram  (v3.4.4)
 ...
 *    Patches are documented and reapplicable via:
 *      patch_v206_gcc14.sh
 *    The patched source is archived in:
 *      ~/Dropbox/PAULO/ROBOTS/Arduino/libraries/_archives/
 *
